(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Parallax = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){="" *="" object-assign="" (c)="" sindre="" sorhus="" @license="" mit="" 'use="" strict';="" eslint-disable="" no-unused-vars="" var="" getownpropertysymbols="Object.getOwnPropertySymbols;" hasownproperty="Object.prototype.hasOwnProperty;" propisenumerable="Object.prototype.propertyIsEnumerable;" function="" toobject(val)="" {="" if="" (val="==" null="" ||="" val="==" undefined)="" throw="" new="" typeerror('object.assign="" cannot="" be="" called="" with="" or="" undefined');="" }="" return="" object(val);="" shouldusenative()="" try="" (!object.assign)="" false;="" detect="" buggy="" property="" enumeration="" order="" in="" older="" v8="" versions.="" https:="" bugs.chromium.org="" p="" issues="" detail?id="4118" test1="new" string('abc');="" eslint-disable-line="" no-new-wrappers="" test1[5]="de" ;="" (object.getownpropertynames(test1)[0]="==" '5')="" test2="{};" for="" (var="" i="0;" <="" 10;="" i++)="" test2['_'="" +="" string.fromcharcode(i)]="i;" order2="Object.getOwnPropertyNames(test2).map(function" (n)="" test2[n];="" });="" (order2.join('')="" !="=" '0123456789')="" test3="{};" 'abcdefghijklmnopqrst'.split('').foreach(function="" (letter)="" test3[letter]="letter;" (object.keys(object.assign({},="" test3)).join('')="" 'abcdefghijklmnopqrst')="" true;="" catch="" (err)="" we="" don't="" expect="" any="" of="" the="" above="" to="" throw,="" but="" better="" safe.="" module.exports="shouldUseNative()" ?="" object.assign="" :="" (target,="" source)="" from;="" symbols;="" s="1;" arguments.length;="" s++)="" from="Object(arguments[s]);" key="" from)="" (hasownproperty.call(from,="" key))="" to[key]="from[key];" (getownpropertysymbols)="" symbols="getOwnPropertySymbols(from);" symbols.length;="" (propisenumerable.call(from,="" symbols[i]))="" to[symbols[i]]="from[symbols[i]];" to;="" };="" },{}],2:[function(require,module,exports){="" (function="" (process){="" generated="" by="" coffeescript="" 1.12.2="" (function()="" getnanoseconds,="" hrtime,="" loadtime,="" moduleloadtime,="" nodeloadtime,="" uptime;="" ((typeof="" performance="" "undefined"="" &&="" null)="" performance.now)="" performance.now();="" else="" process="" process.hrtime)="" (getnanoseconds()="" -="" nodeloadtime)="" 1e6;="" hrtime="process.hrtime;" getnanoseconds="function()" hr;="" hr="hrtime();" hr[0]="" 1e9="" hr[1];="" moduleloadtime="getNanoSeconds();" uptime="process.uptime()" 1e9;="" nodeloadtime="moduleLoadTime" (date.now)="" date.now()="" loadtime;="" loadtime="Date.now();" date().gettime()="" date().gettime();="" }).call(this);="" }).call(this,require('_process'))="" },{"_process":3}],3:[function(require,module,exports){="" shim="" using="" browser="" =="" {};="" cached="" whatever="" global="" is="" present="" so="" that="" test="" runners="" stub="" it="" break="" things.="" need="" wrap="" a="" case="" wrapped="" strict="" mode="" code="" which="" doesn't="" define="" globals.="" it's="" inside="" because="" catches="" deoptimize="" certain="" engines.="" cachedsettimeout;="" cachedcleartimeout;="" defaultsettimout()="" error('settimeout="" has="" not="" been="" defined');="" defaultcleartimeout="" ()="" error('cleartimeout="" (typeof="" settimeout="==" 'function')="" cachedsettimeout="setTimeout;" (e)="" cleartimeout="==" cachedcleartimeout="clearTimeout;" ())="" runtimeout(fun)="" (cachedsettimeout="==" settimeout)="" normal="" enviroments="" sane="" situations="" settimeout(fun,="" 0);="" wasn't="" available="" was="" latter="" defined="" ((cachedsettimeout="==" defaultsettimout="" !cachedsettimeout)="" when="" somebody="" screwed="" no="" i.e.="" maddness="" cachedsettimeout(fun,="" catch(e){="" are="" script="" evaled="" trust="" object="" normally="" cachedsettimeout.call(null,="" fun,="" same="" as="" version="" must="" have="" 'this',="" hopfully="" our="" context="" correct="" otherwise="" will="" error="" cachedsettimeout.call(this,="" runcleartimeout(marker)="" (cachedcleartimeout="==" cleartimeout)="" cleartimeout(marker);="" ((cachedcleartimeout="==" !cachedcleartimeout)="" cachedcleartimeout(marker);="" (e){="" cachedcleartimeout.call(null,="" marker);="" error.="" some="" versions="" different="" rules="" vs="" cachedcleartimeout.call(this,="" queue="[];" draining="false;" currentqueue;="" queueindex="-1;" cleanupnexttick()="" (!draining="" !currentqueue)="" return;="" (currentqueue.length)="" (queue.length)="" drainqueue();="" drainqueue()="" (draining)="" timeout="runTimeout(cleanUpNextTick);" len="queue.length;" while(len)="" currentqueue="queue;" while="" (++queueindex="" len)="" (currentqueue)="" currentqueue[queueindex].run();="" runcleartimeout(timeout);="" process.nexttick="function" (fun)="" args="new" array(arguments.length="" 1);="" (arguments.length=""> 1) {
